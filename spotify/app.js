...
app.get('/login', function(req, res) {
  ...
  var scope = 'streaming user-read-private user-read-email user-modify-playback-state app-remote-control user-read-playback-state user-read-currently-playing playlist-read-private';
